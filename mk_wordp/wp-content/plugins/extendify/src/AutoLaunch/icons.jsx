...
export const extendify = (
	<svg viewBox="0 0 2524 492" xmlns="http://www.w3.org/2000/svg">
		<title>{__('Extendify Logo', 'extendify-local')}</title>
		<path
...
export const pulser = (
	<svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
		<title>
			{/* translators: This is a noun describing the loading animation icon. */}
			{_x('Loading animation', 'icon', 'extendify-local')}
		</title>
		<circle
			cx="12"
			cy="12"
...
export const sparkles = (
	<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		<title>{__('Sparkles', 'extendify-local')}</title>
		<path
